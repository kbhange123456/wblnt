...
public class DateWisePDF {

	public static ByteArrayInputStream getDateWise(List<WeighBridgeObj> wboList, LocalDate startDateLD, LocalDate endDateLD) {
        ...
        try {
            ...
            table.setWidths(new int[]{7, 6, 7, 10, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7});
			...
			hcell = new PdfPCell(new Phrase(leadingVar, "Items", headFontBold));
			hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			hcell.setHorizontalAlignment(Element.ALIGN_LEFT);
			hcell.setBorder(2);
			table.addCell(hcell);
            ...
            for(WeighBridgeObj wbo : wboList) {
            	...
            	amounTotal=amounTotal.add(wbo.getAmt());
            	rowBuilder(table,wbo.getEntryTime().toLocalDate().format(formatters),wbo.getId(),wbo.getVnum(),wbo.getPname(),wbo.getMat(),wbo.getVtype(),wbo.getGweight(),wbo.getTweight(),wbo.getPweight(),wbo.getLweight(),wbo.getNweight(),wbo.getChgs(),wbo.getRate(),wbo.getAmt());
            }
...
//            rowBuilder(table,"AMOUNT","0.00","MOBILE NO","",true,false,false,false);
            ...
            table2.setWidths(new int[]{20, 21, 10, 7,7, 7,7, 7, 7, 7});
            
            rowBuilder2(table2, "COUNT : "+wboList.size(), "","","TOTAL",pWeightTotal,lWeightTotal,netWeightTotal,weightChargesTotal,"",amounTotal);
...
//            document.add(address);
            ...
            document.addTitle("Datewise Report");
	...
	private static void rowBuilder2(PdfPTable table, String string1, String string2,String gap,String gap1, BigDecimal pWeightTotal, BigDecimal lWeightTotal, BigDecimal netWeightTotal, BigDecimal weightChargesTotal, String string, BigDecimal amounTotal) {
	...
	private static void rowBuilder(PdfPTable table, String localDate, Long id, String vnum, String pname, String mat,
			String vtype, BigDecimal bigDecimal, BigDecimal bigDecimal2, BigDecimal bigDecimal3, BigDecimal bigDecimal4, BigDecimal bigDecimal5,
			BigDecimal chgs, BigDecimal rate, BigDecimal amt) {
		...
		hcell = new PdfPCell(new Phrase(leadingVar, vtype, headFont));
		hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		hcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		hcell.setBorder(2);
		table.addCell(hcell);

		hcell = new PdfPCell(new Phrase(leadingVar, bigDecimal.toString(), headFont));
		hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		hcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		hcell.setBorder(2);
		table.addCell(hcell);
		
		hcell = new PdfPCell(new Phrase(leadingVar, bigDecimal2.toString(), headFont));
		hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		hcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		hcell.setBorder(2);
		table.addCell(hcell);

		hcell = new PdfPCell(new Phrase(leadingVar, bigDecimal3.toString(), headFont));
		hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		hcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		hcell.setBorder(2);
		table.addCell(hcell);

		hcell = new PdfPCell(new Phrase(leadingVar, bigDecimal4.toString(), headFont));
		hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		hcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		hcell.setBorder(2);
		table.addCell(hcell);

		hcell = new PdfPCell(new Phrase(leadingVar, bigDecimal5.toString(), headFont));
		hcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		hcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		hcell.setBorder(2);
		table.addCell(hcell);
