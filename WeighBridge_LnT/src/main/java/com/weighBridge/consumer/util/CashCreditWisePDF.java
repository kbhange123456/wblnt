...
public class CashCreditWisePDF {

	public static ByteArrayInputStream getCashcreditWise(List<WeighBridgeObj> wboList,String cashcredit, LocalDate startDateLD, LocalDate endDateLD) {
        ...
        try {
            ...
            String reportType = "Ticket type : " + cashcredit;
            ...
            table.setWidths(new int[]{8, 15, 19, 20, 8, 8, 8, 8, 8, 8});
...
//            	weightChargesTotal=weightChargesTotal.add(wbo.getChgs());
            	...
            	rowBuilder(table,wbo.getEntryTime().toLocalDate().format(formatters),wbo.getId(),wbo.getVnum(),wbo.getPname(),wbo.getMat(),wbo.getGweight(),wbo.getTweight(),wbo.getNweight(),wbo.getRate(),wbo.getAmt());
            }
...
//	wbo.getGweight(),wbo.getTweight(),wbo.getNweight(),wbo.getRate(),wbo.getAmt());
	private static void rowBuilder(PdfPTable table, String localDate, Long id, String vnum, String pname, String mat,
			BigDecimal gweight, BigDecimal tweight, BigDecimal nweight, BigDecimal rate, BigDecimal amt) {
