...
public class PartyWisePDF {

	public static ByteArrayInputStream getPartyWise(List<WeighBridgeObj> wboList,String party, LocalDate startDateLD, LocalDate endDateLD) {
        ...
        try {
            ...
            String reportType = "Party Name : " + party;
...
//            	weightChargesTotal=weightChargesTotal.add(wbo.getChgs());
            	...
            	rowBuilder(table,wbo.getEntryTime().toLocalDate().format(formatters),wbo.getId(),wbo.getVnum(),wbo.getMat(),wbo.getGweight(),wbo.getTweight(),wbo.getPweight(),wbo.getNweight(),wbo.getRate(),wbo.getAmt());
            }
...
//            rowBuilder(table,"AMOUNT","0.00","MOBILE NO","",true,false,false,false);
            ...
            table2.setWidths(new int[]{60, 10, 10, 10, 10});
...
//            document.add(address);
	...
	private static void rowBuilder2(PdfPTable table, String string1, String string2,BigDecimal netWeightTotal, String string, BigDecimal amounTotal) {
...
//	rowBuilder(table,wbo.getEntryTime().toLocalDate().format(formatters),wbo.getId(),wbo.getVnum(),wbo.getMat(),wbo.getGweight(),
//			wbo.getTweight(),wbo.getPweight(),wbo.getNweight(),wbo.getRate(),wbo.getAmt());
	private static void rowBuilder(PdfPTable table, String localDate, Long id, String vnum, String mat, BigDecimal gweight, BigDecimal tweight, BigDecimal pweight, BigDecimal nweight, BigDecimal rate, BigDecimal amt) {
