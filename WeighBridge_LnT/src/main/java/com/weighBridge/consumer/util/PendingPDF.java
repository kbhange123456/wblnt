...
public class PendingPDF {
	...
	public static ByteArrayInputStream getPending(List<WeighBridgeObj> wboList) {
        ...
        try {
            ...
            String ws = "Pending vehicles for weighment";
...
//            rt.setAlignment(Element.ALIGN_CENTER);
            ...
            table.setWidths(new int[]{10, 12, 10, 12, 30, 14, 12, 12});
...
//            	weightChargesTotal=weightChargesTotal.add(wbo.getChgs());
            	...
            	rowBuilder(table,wbo.getEntryTime().toLocalDate().format(formatters),wbo.getId(),wbo.getVnum(),wbo.getVtype(),wbo.getPname(),wbo.getMat() ,wbo.getGweight(),wbo.getTweight());
            }
...
//            rowBuilder(table,"AMOUNT","0.00","MOBILE NO","",true,false,false,false);
            ...
            table2.setWidths(new int[]{100});
            
            rowBuilder2(table2, "COUNT : "+wboList.size());
...
//            document.add(rt);
	...
	private static void rowBuilder2(PdfPTable table, String string1) {
